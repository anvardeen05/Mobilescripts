...
public class ZooponAppQA_CreateNewUser {
	@Test
	public void moto_loginUser() throws WebDriverException, IOException, InterruptedException {
		...
		Thread.sleep(2000);
		//Enter Email ID
		driver.findElementById("com.smacar.zooponandroid:id/email").sendKeys("mototest4@gmail.com");
		driver.pressKeyCode(66);
		Thread.sleep(1000);
		//Enter Password
		...
		//driver.pressKeyCode(61);
		//driver.pressKeyCode(66);
		driver.findElementById("com.smacar.zooponandroid:id/img_gps_alert").click();
